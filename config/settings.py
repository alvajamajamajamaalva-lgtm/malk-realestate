...
ALLOWED_HOSTS = os.environ.get('DJANGO_ALLOWED_HOSTS', ','.join([
    '127.0.0.1',
    'localhost',
    'testserver',
    '192.168.100.22',
    ...
    'mohammedamein.pythonanywhere.com',
     '.trycloudflare.com',
    '.up.railway.app',
    '.railway.app',
])).split(',')
...
CSRF_TRUSTED_ORIGINS = [
    'https://mohammedameein-realestate.com',
    'https://www.mohammedameein-realestate.com',
]
